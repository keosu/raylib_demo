...
float dxdt(float x, float y) { return 10.0 * (y - x); }

float dydt(float x, float y, float z) { return -1 * x * z + 28.0 * x - y; }

float dzdt(float x, float y, float z) { return x * y - (8.0 / 3.0) * z; }
...
int main() {
  ...
  while (!WindowShouldClose()) {
    // Update
    GuiSlider({150, 10, 50, 30}, "X", "", &ix, -40.0, 40.0);
    GuiSlider({250, 10, 50, 30}, "Y", "", &iy, -40.0, 40.0);
    GuiSlider({350, 10, 50, 30}, "Z", "", &iz, 0.0, 40.0);
